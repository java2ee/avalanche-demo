...
public class TypeData extends Brick {
	...
	/**
	 * Р”РѕР±Р°РІР»СЏРµС‚ РїРѕР»Рµ С‚РёРїР° РґР°РЅРЅС‹С…. Р­С‚РѕС‚ РјРµС‚РѕРґ РІС‹Р·С‹РІР°РµС‚СЃСЏ РїСЂРё РѕР±СЂР°Р±РѕС‚РєРµ
	 * С„Р°Р№Р»Р° РєРѕРЅС„РёРіСѓСЂР°С†РёРё.
	 * 
	 * @param name РёРјСЏ РїРѕР»СЏ С‚РёРїР° РґР°РЅРЅС‹С…
	 * @param element СЌРєР·РµРјРїР»СЏСЂ РїРѕР»СЏ С‚РёРїР° РґР°РЅРЅС‹С…
	 * @return {@code true}, РµСЃР»Рё РїРѕР»Рµ С‚РёРїР° РґР°РЅРЅС‹С… СѓСЃРїРµС€РЅРѕ РґРѕР±Р°РІР»РµРЅ, РёРЅР°С‡Рµ {@code false} 
	 */
